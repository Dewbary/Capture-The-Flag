...
hoistedDependencies:
  ...
  /cors/2.8.5:
    cors: private
  /create-jest/29.7.0(@types/node@20.9.3)(ts-node@10.9.1):
    create-jest: private
  ...
  /jest-circus/29.7.0:
    jest-circus: private
  /jest-cli/29.7.0(@types/node@20.9.3)(ts-node@10.9.1):
    jest-cli: private
  /jest-config/29.7.0(@types/node@20.9.3)(ts-node@10.9.1):
    jest-config: private
  /jest-diff/29.7.0:
    jest-diff: private
...
pendingBuilds: []
prunedAt: Sat, 06 Jan 2024 17:52:28 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
skipped: []
storeDir: /Users/brendan.dewberry/Library/pnpm/store/v3
